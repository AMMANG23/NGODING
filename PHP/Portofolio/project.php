...
<img src="arman.jpg" alt="" width="30" height="30" class="rounded-circle d-inline-block align-text-top"> MANDAR-DEV</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        ...
        <a class="nav-link active" aria-current="page" href="project.php"><i class="bi bi-award"></i> Project</a>
...
<div class="p-3 mb-1"><center>
  ...
  <p class="text-danger">MY PROJECTS</p>
  </center>
</div>
<center>
...
<div class="card" style="width: 18rem;">
  <img src="key.jpg" class="card-img-top" alt="...">
  <div class="card-body">
